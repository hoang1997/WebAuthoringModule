...
window.onload = function (){
    ...
    if(localStorage && localStorage.getItem("localStoredName")) {
        ...
        for(var i = 0; i < items.length; i++)
        {
            ...
            document.getElementById("contactCarBasket").src = array[checkoutCarImage];
            document.getElementById("contactWheelBasket").src= wheelImages[checkoutWheel];
            document.getElementById("contactNameBasket").innerHTML = checkoutCarName;
            document.getElementById("contactTransBasket").innerHTML = checkoutCarTrans;
            document.getElementById("contactEngBasket").innerHTML = checkoutCarEng;
            document.getElementById("contactPriceBasket").innerHTML = checkoutPrice;
            document.getElementById("contactWheelNameBasket").innerHTML = wheelNames[checkoutWheel];
        }
    }
}