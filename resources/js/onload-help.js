...
window.onload = function (){
    ...
    if(localStorage && localStorage.getItem("localStoredName")) {
        ...
        for(var i = 0; i < items.length; i++)
        {
            ...
            document.getElementById("helpCarBasket").src = array[checkoutCarImage];
            document.getElementById("helpWheelBasket").src= wheelImages[checkoutWheel];
            document.getElementById("helpNameBasket").innerHTML = checkoutCarName;
            document.getElementById("helpTransBasket").innerHTML = checkoutCarTrans;
            document.getElementById("helpEngBasket").innerHTML = checkoutCarEng;
            document.getElementById("helpPriceBasket").innerHTML = checkoutPrice;
            document.getElementById("helpWheelNameBasket").innerHTML = wheelNames[checkoutWheel];
        }
    }
}
