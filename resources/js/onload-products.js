...
window.onload = function (){
    ...
    if(localStorage && localStorage.getItem("localStoredName")) {
        ...
        for(var i = 0; i < items.length; i++)
        {
            ...
            document.getElementById("productCarBasket").src = array[checkoutCarImage];
            document.getElementById("productWheelBasket").src= wheelImages[checkoutWheel];
            document.getElementById("productNameBasket").innerHTML = checkoutCarName;
            document.getElementById("productTransBasket").innerHTML = checkoutCarTrans;
            document.getElementById("productEngBasket").innerHTML = checkoutCarEng;
            document.getElementById("productPriceBasket").innerHTML = checkoutPrice;
            document.getElementById("productWheelNameBasket").innerHTML = wheelNames[checkoutWheel];
        }
    }
}
